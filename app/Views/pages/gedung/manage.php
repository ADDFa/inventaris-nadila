...
<form action="/gedung/insert" method="POST" enctype="multipart/form-data" class="col-lg-10 mx-auto my-5">
    <div class="mb-3 row">
        <div class="col-lg-6">
        ...
        <div class="col-lg-6">
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <select id="tanggal" class="form-select <?= ($validation->hasError('tanggal')) ? 'is-invalid' : '' ?>" aria-label="Default select example" name="tanggal" aria-describedby="tanggalFeedback" data-select="<?= old('tanggal') ?>">
                ...
                <div class="col-lg-4">
                    <label for="bulan" class="form-label">Bulan Pencatatan</label>
                ...
                <div class="col-lg-4">
                    <label for="tahun" class="form-label">Tahun Pencatatan</label>
    ...
    <div class="mb-3 d-flex justify-content-end gap-3">
        <a href="/gedung" class="btn btn-warning">Kembali</a>
