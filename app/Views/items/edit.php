    ...
    <div class="row mb-3">
        <div class="col-lg-6">
            <div class="mb-3">
                ...
                <input id="item_name" name="item_name" type="text" class="form-control <?= $validation->hasError('item_name') ? 'is-invalid' : '' ?>" value="<?= old('item_name') ?? $item->item_name ?>" aria-describedby="item_nameFeedback">
            ...
            <div class="mb-3">
                ...
                <input id="item_total" name="item_total" type="number" class="form-control <?= $validation->hasError('item_total') ? 'is-invalid' : '' ?>" value="<?= old('item_total') ?? $item->item_total ?>" aria-describedby="item_totalFeedback">
            ...
            <div class="mb-3">
                ...
                <input id="item_condition" name="item_condition" type="text" class="form-control <?= $validation->hasError('item_condition') ? 'is-invalid' : '' ?>" value="<?= old('item_condition') ?? $item->item_condition ?>" aria-describedby="item_conditionFeedback">
            ...
            <div class="mb-3">
                ...
                <input id="item_price" name="item_price" type="number" class="form-control <?= $validation->hasError('item_price') ? 'is-invalid' : '' ?>" value="<?= old('item_price') ?? $item->item_price ?>" aria-describedby="item_priceFeedback">
            ...
            <div class="mb-3">
                ...
                <input id="item_brand" name="item_brand" type="text" class="form-control <?= $validation->hasError('item_brand') ? 'is-invalid' : '' ?>" value="<?= old('item_brand') ?? $item->item_brand ?>" aria-describedby="item_brandFeedback">
        ...
        <div class="col-lg-6">
            <div class="mb-3">
                ...
                <input id="record_date" name="record_date" type="datetime-local" class="form-control <?= $validation->hasError('record_date') ? 'is-invalid' : '' ?>" value="<?= old('record_date') ?? date('Y-m-d H:i:s', $item->record_date) ?>" aria-describedby="record_dateFeedback">
            ...
            <div class="mb-3">
                ...
                <div class="row m-0 justify-content-between align-items-center">
                    <select class="form-select" id="room_id" name="room_id" aria-describedby="room_idFeedback" data-select="<?= old('room_id') ?? $item->room_id ?>">
            ...
            <div class="mb-3">
                ...
                <div class="row m-0 justify-content-between align-items-center">
                    <div class="col-lg-9 p-0">
                        <select class="form-select" id="category_id" name="category_id" aria-describedby="category_idFeedback" data-select="<?= old('category_id') ?? $item->category_id ?>">
            ...
            <div class="mb-3">
                ...
                <div class="row m-0 justify-content-between align-items-center">
                    <div class="col-lg-9 p-0">
                        <select class="form-select" id="type_id" name="type_id" aria-describedby="type_idFeedback" data-select="<?= old('type_id') ?? $item->type_id ?>">
